...
text = p.read_text()
needle = """      - name: Purchase policy regression tests
        run: php tests/purchase_policy_regression.php
"""
replacement = needle + """      - name: Synchronization regression tests
        run: php tests/sync_regression.php
"""
if text.count(needle) != 1:
    raise SystemExit('php-lint regression insertion point not found exactly once')
